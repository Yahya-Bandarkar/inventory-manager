    ...
    <>
      <style>{`
        ...
        .reg-input {
          ...
          color: #1a1a2e; outline: none; box-sizing: border-box;
          box-shadow: 0 1px 0 rgba(255,255,255,0.9) inset;
          transition: border 0.2s, background 0.2s;
        }
        .reg-input::placeholder { color: rgba(80,80,120,0.45); }
        .reg-input:focus { background: rgba(255,255,255,0.6); border-color: rgba(139,92,246,0.5); }
        .reg-btn {
      ...
      <div className="reg-wrap">
        ...
        <div className="reg-card">
          ...
          {error && (
            <div style={{ background: 'rgba(239,68,68,0.1)', border: '1px solid rgba(239,68,68,0.25)', borderRadius: '12px', padding: '0.7rem 1rem', marginBottom: '1.25rem', fontSize: '13px', color: '#dc2626' }}>
              {error}
            </div>
          )}
